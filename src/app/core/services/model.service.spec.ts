...
describe('ModelService', () => {
  ...
  it(
    'should expose model data in observable',
  ...
  it(
    'should use immutable data in exposed observable by default',
    inject([ModelFactory], (modelFactory: ModelFactory<TestModel>) => {
      const model = modelFactory.create({ value: 'test' });
  ...
  it(
    'should use mutable data in exposed observable when configured',
    inject([ModelFactory], (modelFactory: ModelFactory<TestModel>) => {
  ...
  it(
    'should use custom clone function when configured',
    inject([ModelFactory], (modelFactory: ModelFactory<TestModel>) => {
  ...
  it(
    'should create multiple independent instances',
    inject([ModelFactory], (modelFactory: ModelFactory<TestModel>) => {
      ...
      model2.data$.subscribe(data =>
        expect(data).toEqual({ value: 'changed' })
      );
    })
  );
});
